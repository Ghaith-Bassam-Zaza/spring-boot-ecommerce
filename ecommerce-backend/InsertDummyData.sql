-- these queries are generated using AI I only made slight changes
...
SELECT TOP 1 @order1 = id FROM web_order WHERE address_id = @address1 AND local_user_id = @userId1 ORDER BY id DESC
SELECT @order2 = id FROM web_order WHERE address_id = @address1 AND local_user_id = @userId1 ORDER BY id DESC OFFSET 1 ROW FETCH FIRST 1 ROW ONLY
SELECT  @order3 = id FROM web_order WHERE address_id = @address1 AND local_user_id = @userId1 ORDER BY id DESC OFFSET 2 ROW FETCH FIRST 1 ROW ONLY
SELECT TOP 1 @order4 = id FROM web_order WHERE address_id = @address2 AND local_user_id = @userId2 ORDER BY id DESC
SELECT @order5 = id FROM web_order WHERE address_id = @address2 AND local_user_id = @userId2 ORDER BY id DESC OFFSET 1 ROW FETCH FIRST 1 ROW ONLY
